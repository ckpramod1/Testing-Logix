 ...
 <p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;">  Registration No. MTO / DGS / 2569 / JAN / 2025</p>
  ...
  <div style="float:left; width:1024px; min-height:45px;">
    ...
    <div style="float:left; height: 63px;width:290px; border-right:1px solid #000;border-top:1px solid #000;"class="borderhide">
        ...
        <p style="font-size:14px; font-weight:normal;  padding:0px 5px 5px 10px; margin:0px;position:relative;top:-265px;"><asp:Label ID="lbl_vessel" runat="server"></asp:Label>/<asp:Label ID="lbl_voy" runat="server"></asp:Label></p>
      </div>
...
<p style="float: left;
    ...
    position: relative;
    top: -427px;
    left: 50px;">by____________Signed on behalf of the Carrier / Agent</p>
            </div>
